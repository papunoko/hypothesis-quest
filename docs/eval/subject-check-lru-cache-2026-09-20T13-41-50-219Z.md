# 題材検査 lru-cache 2026-09-20T13-41-50-219Z
...
| 検査 | 結果 | 詳細 |
| --- | --- | --- |
| truth-passes-all | ○ | 7/7 一致 / 読み: {"rule":0.97,"form":0.87,"order":0.92,"types":0.5,"singleFast":0.93,"typed":0.97} |
| expectation-splits-pair | ✗ | L5:undetermined, L6:undetermined（全体の食い違い 3/7） |
| paradox-hides-cause | ○ | cause=0.13（< 0.30） |
